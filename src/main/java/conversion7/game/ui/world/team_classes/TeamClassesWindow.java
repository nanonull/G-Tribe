...
public class TeamClassesWindow extends AnimatedWindow {

    public static final int TREE_WIDGET_PADDING = (int) (UnitClassTreeNode.BUTTON_SIZE * 0.5f);
    private TreeWidget treeWidget;

    public TeamClassesWindow(Stage stage, String title, Skin skin, int direction) {
        ...
        rootNodes.add(UnitClassConstants.DESIGN_TABLE_THE_OLDEST_CLASSES.get(Propliopithecus.class));
