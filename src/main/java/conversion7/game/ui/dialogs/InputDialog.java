...
public class InputDialog extends AbstractInfoDialog implements InputProviderReset {
    ...
    public void startFor(InputFoodForRitualSubaction ritualSubAction) {
        inputResolver = ritualSubAction;
        getTitleLabel().setText("Input food amount for ritual");
        description.setText("How much food you want use for ritual?\nAvailable food: "
                + ritualSubAction.getParentAction().getObject().getFoodStorage().getFood());
        show();
    }
    ...
    public void startFor(InputFoodForShareSubaction inputFoodForShareAction) {
        ...
        description.setText("How much food you want give to the selected army?\nAvailable food: "
                + inputFoodForShareAction.getParentAction().getObject().getFoodStorage().getFood());
        show();
    }
}
