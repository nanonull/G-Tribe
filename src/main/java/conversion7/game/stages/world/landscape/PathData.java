...
public class PathData implements Comparable<PathData> {
    ...
    public boolean isObstacle() {
        return !cell.hasLandscapeAvailableForMove() || cell.isSeized() || obstacleAsFiltered;
    }
    ...
    public Cell findNotObstacleCellClosestToStart(Cell startCell) {
        Cell theClosestCell = CellDistanceToComparator.instance().sort(cell.getNeighborCells(), startCell).get(0);
    ...
    public Cell findNotObstacleClosestToGoalAndStart(Cell startCell) {
