...
//            if (LOG.isDebugEnabled()) LOG.debug("findNotObstacleCellClosestToStart is: " + goalCell.pathData.findNotObstacleCellClosestToStart(startCell));
            goalCell = goalCell.pathData.findNotObstacleClosestToGoalAndStart(startCell);
        ...
        while (openList.size != 0) {
            ...
            for (Cell neighborCell : currentOpen.cell.getNeighborCells()) {
