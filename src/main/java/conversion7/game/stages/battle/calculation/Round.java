...
import conversion7.game.stages.battle.TeamSide;
...
public class Round implements Progressive {
    ...
    public void invertSides() {
        ...
        for (TeamSide teamSide : battle.aliveTeamSides) {
            teamSide.setBattleSide(GdxgConstants.INVERT_TEAM.get(teamSide.getBattleSide()));
        }
    }
