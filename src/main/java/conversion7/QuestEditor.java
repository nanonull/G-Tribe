...
public class QuestEditor extends ClientCore {
    ...
    public static void main(String[] args) {
        ClientApplication.start(new QuestEditor());
    }
    ...
    public void create() {
        ...
        skin = Assets.uiSkin;
        stageGUI = core.graphic.getClientUi().stageGUI;

        mainTable = new DefaultTable().applyDefaultPaddings();
        stageGUI.addActor(mainTable);
        mainTable.pad(ClientUi.SPACING);
        mainTable.setFillParent(true);
        mainTable.setBackground(new TextureRegionColoredDrawable(new Color(0.0F, 0.0F, 0.0F, 0.7F), Assets.pixelWhite));
