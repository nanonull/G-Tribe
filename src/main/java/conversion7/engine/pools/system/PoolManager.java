...
public class PoolManager {
    ...
    public static final TownFragmentModelPool TOWN_FRAGMENT_MODEL_POOL = new TownFragmentModelPool();
    ...
    public static final Pool<DecalActor> UNEXPLORED_DECAL_POOL = new UnexploredDecalPool();
    public static final Pool<DecalActor> NOT_VISIBLE_DECAL_POOL = new NotVisibleDecalPool();
    ...
    public static DecalActor getFloorDecal(Cell cell) {
        ...
        if (landType.equals(Landscape.TYPE.COMMON)
                || landType.equals(Landscape.TYPE.MOUNTAINS)) {
