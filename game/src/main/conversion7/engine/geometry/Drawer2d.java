...
public class Drawer2d {
    ...
    public static void drawRect(int x, int y, int width, int height, int thickness) {
        Gdxg.spriteBatch.draw(Assets.pixel, x, y, width, thickness);
        Gdxg.spriteBatch.draw(Assets.pixel, x, y, thickness, height);
        Gdxg.spriteBatch.draw(Assets.pixel, x, y + height - thickness, width, thickness);
        Gdxg.spriteBatch.draw(Assets.pixel, x + width - thickness, y, thickness, height);
