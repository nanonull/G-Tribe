...
public class OthersTotemCellSelectionPool extends FlushablePool<SceneNode3d> {

    @Override
    protected SceneNode3d newObject() {
        ModelActor actor = Modeler.buildCellSelector(Color.ORANGE,
                0.25f, 0.9f, Modeler.LEVEL1_SELECTION_ALPHA);
        return actor;
    }
