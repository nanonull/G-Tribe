...
public abstract class SceneNode3d implements LinkedPoolable, Disposable {
    ...
    private void calculateFrustrumVisible() {
        if (parent != null && !parent.isFrustrumVisible()) {
            ...
            frustrumVisible = frustrumRadius <= 0 || stage.getCamera().frustum.sphereInFrustum(globalPosition, frustrumRadius);
        }
    }
