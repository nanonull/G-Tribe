...
public class MeshShaderTest extends Game {
    ...
    public static void main(String[] args) {
        ClientApplication.startLibgdxCoreApp(new MeshShaderTest());
    }
    ...
    public void create() {
        ...
        texture = new Texture(Gdx.files.internal(Assets.IMAGES_FOR_ATLAS_FOLDER + "grass_128.png"));
    }
