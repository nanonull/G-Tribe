...
import conversion7.game.stages.battle_deprecated.contollers.AbstractActionController;
...
public class FigureStepParams {
    ...
    /** NEW: {@link BattleFigure#dead} */
    @Deprecated
    public boolean zeroLifed;
    ...
    public int getDamage() {
        return 1;
//        return battleFigure.getWorldUnit().getMeleeDamage();
    }
    ...
    public boolean hit(FigureStepParams target) {
        ...
        if (damage > 0) {
            ...
            if (target.life <= 0) {
                ...
                target.zeroLifed = true;
                target.battleFigure.setDead(true);
                this.battleFigure.experience += 10;
                return true;
            }

            this.battleFigure.experience += 1;
        }
