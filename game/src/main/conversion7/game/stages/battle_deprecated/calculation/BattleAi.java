...
import conversion7.game.stages.battle_deprecated.contollers.AttackController;
import conversion7.game.stages.battle_deprecated.contollers.IdleController;
import conversion7.game.stages.battle_deprecated.contollers.MoveController;
...
public class BattleAi {
    ...
    private static boolean getNeighborEnemy(FigureStepParams figureStepParams) {
        ...
        for (int i = 0; i < BattleConstants.CELLS_AROUND.size; i++) {
            Point p = BattleConstants.CELLS_AROUND.get(i);
    ...
    private static boolean getFarEnemy(FigureStepParams figureStepParams) {
        ...
        Array<Point> farScope = BattleConstants.SEARCH_FAR_TARGET_CELLS.get(figureStepParams.battleFigure.getBattleSide());
    ...
    private static boolean getMoveForward(FigureStepParams figureStepParams) {
        ...
        Point p = BattleConstants.NEXT_FORWARD_CELL.get(figureStepParams.battleFigure.getBattleSide());
