...
public class SplitMergeUnitsWindow extends AnimatedWindow {
    ...
    public void showFor(AbstractSquad object, Cell target) {
    ...
    private void refreshContent(AbstractSquad squad, Cell target) {
        ...
        splitMergeUnitsController.setInitiatorTeam(squad.getTeam());
        splitMergeUnitsController.getLeftSide().wrapAreaObject(squad);

        if (target.hasSquad()) {
            AbstractSquad secondObject = target.getSquad();
